...
public class ArcPipeline {
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("zenya", "arc"))
                    .withVertexShader(Identifier.of("zenya", "arc_vertex"))
                    .withFragmentShader(Identifier.of("zenya", "arc_fragment"))
    ...
    public static void draw(Matrix4f matrix, float x, float y, float size, float thickness, float degree,
        ...
        buffer.position(64);
        buffer.putFloat(x).putFloat(y).putFloat(size).putFloat(size); // uRect
        buffer.putFloat(size).putFloat(thickness).putFloat(degree).putFloat(rotation); // uParams
        buffer.putFloat(z).putFloat(0).putFloat(0).putFloat(0); // uZ_Padding
