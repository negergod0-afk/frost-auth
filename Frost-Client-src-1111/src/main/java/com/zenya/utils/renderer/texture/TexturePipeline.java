...
public class TexturePipeline {
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("zenya", "texture"))
                    .withVertexShader(Identifier.of("zenya", "texture_vertex"))
                    .withFragmentShader(Identifier.of("zenya", "texture_fragment"))
            ...
            System.err.println("[Texture2D] Failed to init: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public static void draw(Matrix4f matrix, float x, float y, float size, GpuTextureView textureView, int color,
        ...
        buffer.putFloat(radius).putFloat(0).putFloat(0).putFloat(0);
